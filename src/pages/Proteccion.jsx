...
const Proteccion = () => {
  return (
    <>
      <ScrollRestoration />
      <MainNavigation />
      <div className="max-w-[1600px] xl:mx-auto px-[1rem] lg:px-[4rem]">
        <h1 className="uppercase mt-[6rem] text-base lg:text-xl xl:text-2xl opacity-[0.7] self-start ms-[1rem] justify-self-start">
          PROTECCIÓN DE DATOS
        </h1>
        <div className="pt-[1rem] p-[3rem]">
          ...
          <p>
            ...
            en el fin de prestarle los servicios o información que nos soliciten
            así como facilitar a los interesados información de acuerdo con sus
          ...
          <p>
            ...
            prestación de los servicios solicitados mientras dure la relación
            comercial, se conservarán durante un plazo de 5 años a partir de la
          ...
          <p>
            ...
            los datos ya no sean necesarios para los fines para los que fueron
            recogidos.
          </p>
          <p>
            ...
            Romero García dejará de tratar los datos, salvo por motivos
            legítimos imperiosos, o en el ejercicio o defensa de reclamaciones.
          </p>
        </div>
      </div>
      <Footer />
