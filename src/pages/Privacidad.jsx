      ...
      <div className="p-[3rem] pt-[1rem]">
        <ol className="list-decimal">
          ...
          <p>
            ...
            expresa. Los datos recabados a través de los formularios de recogida
            de datos del sitio web u otras vías serán incorporados a los
            sistemas de tratamiento de Héctor Romero García.
          </p>
          <p>
            ...
            personales y a la libre circulación de estos datos y la Ley 34/2002,
          ...
          <p>
            Tratamos la información que nos facilitan los interesados de manera
            leal, lícita y transparente dando cumplimiento a la normativa UE
            2016/679 de 27 de abril del Parlamento Europeo y del Consejo y Ley
            3/2018 de 5 de diciembre de Protección de datos y garantía de
            derechos digitales.
          </p>
          ...
          <ul className="list-disc mb-6 list-inside">
            ...
            <li>
              Otros datos (facilitados por el interesado en formularios abiertos
              o comunicaciones)
            </li>
          </ul>
          ...
          <p>
            Los datos personales proporcionados y obtenidos durante la relación
            serán conservados durante un plazo máximo de 5 años a partir de la
            última confirmación de interés o mientras nos obligue una previsión
            legal, en cuyo caso serán conservados debidamente bloqueados y
            eliminados cuando no sea necesario.
          </p>
          <p>¿Cuál es la legitimación para el tratamiento de sus datos?</p>
          <p>
            En cumplimiento del artículo 6.1 del Reglamento UE 2016/679 de 27 de
            abril le informamos que la legitimación para el tratamiento de sus
          ...
          <ol className="list-decimal list-inside mb-6">
            ...
            <li className="mb-2">
              ...
              legal aplicable al responsable del tratamiento y/o
            </li>
            <li className="mb-2">
          ...
          <p>
            Los datos tratados podrán ser comunicados a terceros cuando así nos
            obligue una previsión legal.
          </p>
          <p>
            ...
            empresariales (administración, contabilidad, fiscalidad, marketing,
            laboral…). La relación con estas empresas está regulada según el
            artículo 28 del Reglamento UE 2016/679 de 27 de abril del Parlamento
            Europeo y del Consejo (RGPD). Los datos accedidos desde dichas
            empresas solo serán utilizados para el fin empresarial necesario no
            siendo conservados para cualquier fin ulterioro
          </p>
          ...
          <p>
            ...
            usuarios también podrán oponerse al tratamiento de sus datos. Se
            dejará de tratar los datos, salvo por motivos legítimos imperiosos,
            o en el ejercicio o defensa de reclamaciones.
          </p>
          <p>
            El usuario puede enviar un escrito a Héctor Romero García, al
            domicilio del responsable, o bien por medio de un correo electrónico
            indicado en el encabezado de la presente Política, adjuntando
            fotocopia de su documento de identidad, en cualquier momento y de
          ...
          <p>
            Se adoptan los niveles de seguridad correspondientes requeridos por
            la citada normativa de Protección de Datos de Carácter Personal y
            demás normativa aplicable. Dichos niveles de seguridad son obligados
            para aquellas entidades que accedan a nuestra información en virtud
            de una relación contractual y/o prestación de servicio, en
            aplicación del artículo 28 del Reglamento UE 2016/679 (RGPD)
          </p>
          <p>
          ...
          <p>
            ...
            Revise nuestra política de cookies a través del enlace que
            encontrará en esta web.
          </p>
          <p>
            Si opta a abandonar nuestro sitio web a través de enlaces a sitios
            web no pertenecientes a nuestra entidad, no seré hará responsable de
            las políticas de privacidad de dichos sitios web ni de las cookies
          ...
          <p>
            ...
            en conformidad con lo dispuesto en el Título III, artículo 22 de la
