    ...
    <>
      ...
      <div className="p-[3rem] pt-[1rem]">
        <ol className="list-decimal">
          ...
          <p>
            La navegación por el sitio web de EL PROPIETARIO DE LA WEB atribuye
            ...
            este Aviso Legal, que pueden sufrir modificaciones.La navegación por
            el sitio web de EL PROPIETARIO DE LA WEB atribuye la condición de
            usuario del mismo e implica la aceptación plena y sin reservas de
          ...
          <p>
            ...
            a EL PROPIETARIO DE LA WEB o frente a terceros, de cualesquiera
          ...
          <ul className="list-disc mb-6 list-inside">
            ...
            <li>
              Su domicilio está en: Avda. Ciudad de Barcelona 13 (28007) Madrid
            </li>
          </ul>
          ...
          <p>
            ...
            datos que comunique a EL PROPIETARIO DE LA WEB y será el único
          ...
          <p>
            ...
            contenidos y servicios de EL PROPIETARIO DE LA WEB y a no emplearlos
            para, entre otros:
          </p>
          <ol className="list-decimal list-inside mb-6">
            ...
            <li className="mb-2">
              ...
              o daños en los documentos electrónicos, datos o sistemas físicos y
              lógicos de EL PROPIETARIO DE LA WEB o de terceras personas; así
              como obstaculizar el acceso de otros usuarios al sitio web y a sus
            ...
            <li className="mb-2">
              ...
              usuarios o a áreas restringidas de los sistemas informáticos de EL
            ...
            <li className="mb-2">
              ...
              de los correspondientes derechos o ello resulte legalmente
              permitido.
            </li>
            <li className="mb-2">
              Recabar datos con finalidad publicitaria y de remitir publicidad
              de cualquier clase y comunicaciones con fines de venta u otras de
          ...
          <p>
            ...
            pertenece a EL PROPIETARIO DE LA WEB, sin que puedan entenderse
          ...
          <p>
            ...
            redes, ni sean objeto de ningún tipo de explotación. Asimismo, todas
            las marcas, nombres comerciales o signos distintivos de cualquier
            clase que aparecen en el sitio web son propiedad de EL PROPIETARIO
            DE LA WEB, sin que pueda entenderse que el uso o acceso al mismo
          ...
          <p>
            ...
            propietario del sitio web en la que se establezca, ni la aceptación
            y aprobación por parte de EL PROPIETARIO DE LA WEB de sus contenidos
            o servicios. Aquellas personas que se propongan establecer un
            hiperenlace previamente deberán solicitar autorización por escrito a
            EL PROPIETARIO DE LA WEB. En todo caso, el hiperenlace únicamente
            permitirá el acceso a la home-page o página de inicio de nuestro
            sitio web, asimismo deberá abstenerse de realizar manifestaciones o
            indicaciones falsas, inexactas o incorrectas sobre EL PROPIETARIO DE
            LA WEB, o incluir contenidos ilícitos, contrarios a las buenas
            costumbres y al orden público. EL PROPIETARIO DE LA WEB no se
            responsabiliza del uso que cada usuario le dé a los materiales
          ...
          <ol className="list-decimal list-inside mb-6">
            ...
            <li className="mb-2">
              ...
              de las actuaciones de terceros que vulneren derechos de propiedad
          ...
          <p>
            ...
            los contenidos que ofrece este sitio web. EL PROPIETARIO DE LA WEB
          ...
          <p>
            ...
            responsabilidad que la información proporcionada en la notificación
            es exacta.
          </p>
          <p>
            Las partes se someten expresamente, para cualesquiera cuestiones o
            divergencias que pudieren suscitarse por razón de la interpretación,
            cumplimiento y ejecución de este contrato, a la jurisdicción y
            competencia de los Juzgados y Tribunales correspondientes al
