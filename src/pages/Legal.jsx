...
const Legal = () => {
  return (
    <>
      <ScrollRestoration />
      <MainNavigation />
      <div className="max-w-screen-xl xl:mx-auto px-[1rem] lg:px-[4rem]">
        <h1 className="uppercase mt-[6rem] text-base opacity-[0.7] self-start justify-self-start">
          AVISO LEGAL
        </h1>
        <div className="p-[3rem] pt-[1rem]">
          <ol className="list-decimal">
            ...
            <p>
              El presente aviso legal regula el uso del sitio web (en adelante,
              LA WEB), del que es titular Héctor Romero García (en adelante, EL
              PROPIETARIO DE LA WEB).
            </p>
            <p>
              La navegación por el sitio web de EL PROPIETARIO DE LA WEB
              ...
              incluidas en este Aviso Legal, que pueden sufrir modificaciones.La
              navegación por el sitio web de EL PROPIETARIO DE LA WEB atribuye
              la condición de usuario del mismo e implica la aceptación plena y
            ...
            <p>
              ...
              del tráfico y el presente Aviso Legal. El usuario responderá
            ...
            <p>
              EL PROPIETARIO DE LA WEB, en cumplimiento de la Ley 34/2002, de 11
            ...
            <ul className="list-disc mb-6 list-inside">
              ...
              <li>
                Su domicilio está en: Avda. Ciudad de Barcelona 13 (28007)
                Madrid
              </li>
            </ul>
            <p>Para comunicarse hay diferentes medios de contacto:</p>
            <ul className="list-disc mb-6 list-inside">
              <li>Mail: art@hectoromero.es</li>
              <li>Tlfno: 645979039</li>
            </ul>
            <p>
              ...
              efectos, cuando se realicen a través de correo postal o cualquier
            ...
            <p>
              ...
              aquellos datos que comunique a EL PROPIETARIO DE LA WEB y será el
            ...
            <p>
              ...
              los contenidos y servicios de EL PROPIETARIO DE LA WEB y a no
            ...
            <ol className="list-decimal list-inside mb-6">
              <li className="mb-2">
                ...
                general, contrarios a la ley o al orden público.
              </li>
              <li className="mb-2">
                Introducir en la red virus informáticos o realizar actuaciones
                susceptibles de alterar, estropear, interrumpir o generar
                errores o daños en los documentos electrónicos, datos o sistemas
                físicos y lógicos de EL PROPIETARIO DE LA WEB o de terceras
                ...
                recursos informáticos a través de los cuales EL PROPIETARIO DE
                LA WEB presta sus servicios.
              </li>
              <li className="mb-2">
                ...
                EL PROPIETARIO DE LA WEB o de terceros y, en su caso, extraer
                información.
              </li>
              <li className="mb-2">
                Vulnerar los derechos de propiedad intelectual o industrial, así
                como violar la confidencialidad de la información de EL
              ...
              <li className="mb-2">
                Recabar datos con finalidad publicitaria y de remitir publicidad
                de cualquier clase y comunicaciones con fines de venta u otras
                de naturaleza comercial sin que medie su previa solicitud o
                consentimiento.
              </li>
            </ol>
            <p>
              ...
              propiedad pertenece a EL PROPIETARIO DE LA WEB, sin que puedan
            ...
            <p>
              ...
              a redes, ni sean objeto de ningún tipo de explotación. Asimismo,
              ...
              PROPIETARIO DE LA WEB, sin que pueda entenderse que el uso o
              acceso al mismo atribuya al usuario derecho alguno sobre los
              mismos.
            </p>
            <p>
            ...
            <p>
              ...
              existencia de relaciones entre EL PROPIETARIO DE LA WEB y el
              propietario del sitio web en la que se establezca, ni la
              aceptación y aprobación por parte de EL PROPIETARIO DE LA WEB de
              sus contenidos o servicios. Aquellas personas que se propongan
              establecer un hiperenlace previamente deberán solicitar
              autorización por escrito a EL PROPIETARIO DE LA WEB. En todo caso,
            ...
            <p>
              EL PROPIETARIO DE LA WEB excluye, hasta donde permite el
            ...
            <ol className="list-decimal list-inside mb-6">
              <li className="mb-2">
                ...
                disposición a los que se haya accedido a través del sitio web o
              ...
              <li className="mb-2">
                ...
                del uso incorrecto del sitio web. En particular, y a modo
                ejemplificativo, EL PROPIETARIO DE LA WEB no se hace responsable
                de las actuaciones de terceros que vulneren derechos de
                propiedad intelectual e industrial, secretos empresariales,
                derechos al honor, a la intimidad personal y familiar y a la
                propia imagen, así como la normativa en materia de competencia
                desleal y publicidad ilícita.
              </li>
            </ol>
            <p>
              Asimismo, EL PROPIETARIO DE LA WEB declina cualquier
              ...
              La función de los links que aparecen en esta web es exclusivamente
              la de informar al usuario sobre la existencia de otras fuentes
              susceptibles de ampliar los contenidos que ofrece este sitio web.
              EL PROPIETARIO DE LA WEB no garantiza ni se responsabiliza del
              funcionamiento o accesibilidad de los sitios enlazados; ni
              sugiere, invita o recomienda la visita a los mismos, por lo que
              tampoco será responsable del resultado obtenido. EL PROPIETARIO DE
              LA WEB no se responsabiliza del establecimiento de hipervínculos
            ...
            <p>
              ...
              través del sitio web, deberá enviar una notificación a EL
              PROPIETARIO DE LA WEB identificándose debidamente, especificando
              las supuestas infracciones y declarando expresamente y bajo su
              responsabilidad que la información proporcionada en la
              notificación es exacta.
            </p>
            <p>
              Las partes se someten expresamente, para cualesquiera cuestiones o
              divergencias que pudieren suscitarse por razón de la
              interpretación, cumplimiento y ejecución de este contrato, a la
              jurisdicción y competencia de los Juzgados y Tribunales
              correspondientes al domicilio del usuario o a los del lugar de
            ...
            <p>
              ...
              formalmente a los diarios oficiales de las administraciones
              públicas, que constituyen el único instrumento que da fe de su
              autenticidad y contenido. La información disponible en este sitio
