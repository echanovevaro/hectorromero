...
export default function Gallery({ coleccion }) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-start items-start gap-2 pt-[5rem] max-w-[1344px] min[1600px]:mx-auto mx-[1rem] lg:mx-[8rem]">
        ...
        <div
          className={`flex items-center justify-center flex-col gap-2 w-full h-screen`}
        >
          <div
                    ...
                    <>
                      ...
                      <div className="relative w-full">
                        <motion.img
                          ...
                          src={obra.imagenURL}
                          alt={obra.titulo}
                          className="inline-block object-cover overflow-hidden max-h-[80vh] w-full touch-pinch-zoom"
